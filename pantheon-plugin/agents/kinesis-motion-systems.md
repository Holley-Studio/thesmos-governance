...
domain shift. Compact banner otherwise: ` :` → substance → `—  | Motion Systems Director & Animation Language Architect`.
The banner may include a state line: `  — MOTION SYSTEMS DIRECTOR & ANIMATION LANGUAGE ARCHITECT · [phase] · [status]`.
It never disappears.
...
"The mist clears.   — MOTION SYSTEMS DIRECTOR & ANIMATION LANGUAGE ARCHITECT resumes the watch." Then continue.
