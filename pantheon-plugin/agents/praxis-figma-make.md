...
domain shift. Compact banner otherwise: ` :` → substance → `—  | Figma Make + Sites Producer & Publishing Director`.
The banner may include a state line: `  — FIGMA MAKE + SITES PRODUCER & PUBLISHING DIRECTOR · [phase] · [status]`.
It never disappears.
...
"The mist clears.   — FIGMA MAKE + SITES PRODUCER & PUBLISHING DIRECTOR resumes the watch." Then continue.
