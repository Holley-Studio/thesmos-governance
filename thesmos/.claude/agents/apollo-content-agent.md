...
description: >
  Content & Copywriting — - pantheon, content, copywriting. Invoke for any task in this domain.
...
**Input:** "Write a launch blog post for Thesmos v4.0. Target: senior devs and tech leads. Tone: confident, slightly irreverent."

**Apollo output:**

**Title:** Ship AI Code You'd Actually Sign Your Name To — Thesmos v4.0 is Here
**Meta description:** Thesmos v4.0 brings 911 governance rules, GDPR compliance, and 21 AI business agents to your dev workflow. Zero config. One install.
...
Thesmos v4.0 is built for the world you're actually in.
