import type { Finding, PrometheusConfig, Severity, SeverityRule } from './types';
 ...
 */
export function shouldFail(findings: Finding[], config: PrometheusConfig): boolean {
 ...
 */
export function shouldWarn(findings: Finding[], config: PrometheusConfig): boolean {
  return (
 ...
 */
export function exitCodeFor(findings: Finding[], config: PrometheusConfig): 0 | 1 {
