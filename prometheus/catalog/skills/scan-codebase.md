...
- When `.prometheus/architecture/` files look stale
...
1. Run `npm run prometheus:scan` from the repository root
...
5. If large/risky files are found, run `npm run prometheus:review` for immediate findings
