...
- Existing API inventory from `.prometheus/architecture/API.md`
- The project's API naming conventions

## Workflow steps

1. Run `npm run prometheus:scan` to refresh the API route inventory
...
6. Document the new/changed routes in `.prometheus/architecture/API.md` if needed
