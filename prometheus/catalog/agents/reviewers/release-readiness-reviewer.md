...
- `.prometheus/report.json` — most recent review findings
...
- Do not flag stale adapters if the last `prometheus adapters` run was within the configured freshness window
