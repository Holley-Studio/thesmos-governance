# Product Hunt Launch Kit (week 11-13, after momentum builds)

Launch Tuesday-Thursday, 00:01 PT. Line up 10-15 supporters to engage in hour 1.
Position as "specific workflows with theatrical routing" — never "a prompt pack."

## Listing

**Name:** Thesmos Pantheon
**Tagline:** A council of AI gods, orchestrated by Zeus — in every AI tool you use
...
Hey PH 👋 — I built this because working with one generic assistant felt like
hiring one employee for every job in the company.
...
1. Council assembly transcript — "You always know who's working for you"
2. VS Code god tree + status bar routing chain — "Watch them work. Live."
3. Council Decision Card — "Verdicts you can screenshot"
4. 10-platform grid — "One pantheon, everywhere"
5. Free vs full tiers — "Start free, summon everyone later"
