...
The ladder: **$0 (Essentials — 288 rules, 5 agents) → $79 (Full Pantheon — full 1,137-rule engine, 67 agents)**, one-time, no subscription (`website/pricing.html`).
...
Channel (growth/reddit, growth/x-threads, growth/product-hunt, growth/shorts, growth/medium)
  ...
  → Free tier: CLI (npm install, 288-rule Essentials) OR Essentials agent zip (5 agents, no email required)
