...
| 1,137 governance rules, 10 languages | Broad coverage without needing Semgrep's config tuning overhead | `website/vs.html`, `website/pricing.html` — consistent 1,137 figure across both. 289 are free (Essentials tier); the remaining 848 unlock with the $79 Full Pantheon. |
...
The ladder: **$0 (Essentials — 289 rules, 5 agents) → $79 (Full Pantheon — full 1,137-rule engine, 67 agents)**, one-time, no subscription (`website/pricing.html`).
...
Channel (growth/reddit, growth/x-threads, growth/product-hunt, growth/shorts, growth/medium)
  ...
  → Free tier: CLI (npm install, 289-rule Essentials) OR Essentials agent zip (5 agents, no email required)
