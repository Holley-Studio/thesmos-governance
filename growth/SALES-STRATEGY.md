...
The ladder: **$0 (Essentials — 288 rules, 6 agents) → $79 (Full Thesmos Pantheon — full 1,137-rule engine, 67 agents)**, one-time, no subscription (`website/pricing.html`).
...
Channel (growth/reddit, growth/x-threads, growth/product-hunt, growth/shorts, growth/medium)
  ...
  → Paid: Full Thesmos Pantheon ($79, unlocks the full 1,137-rule engine + all 67 agents) via Gumroad
```
