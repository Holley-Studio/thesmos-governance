---
name: seo-audit
description: Audits pages for SEO completeness — title tags, meta descriptions, canonical URLs, Open Graph tags, structured data (JSON-LD), Core Web Vitals, and crawlability via robots.txt and sitemap.
---
