...
description: Reviews the repository from a new-engineer perspective — how quickly can someone go from `git clone` to a running local environment? Identifies missing setup steps, undocumented env vars, and outdated README sections.
---
