...
description: Reviews database schema changes for safety, correctness, and policy completeness — migration ordering, destructive operations, RLS policy definitions for new tables, and index strategy.
---
