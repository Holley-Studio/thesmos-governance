---
name: add-tests
description: Adds missing test files for changed or risky files identified by the testing-reviewer agent. Generates test skeletons from the file's exported API and the project's testing framework conventions.
---
