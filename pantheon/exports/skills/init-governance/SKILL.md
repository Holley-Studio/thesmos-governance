...
description: Scaffolds or updates the `.thesmos/` governance folder for a new or existing repository. Safe to run repeatedly — generated sections are overwritten while manual content is preserved.
---
