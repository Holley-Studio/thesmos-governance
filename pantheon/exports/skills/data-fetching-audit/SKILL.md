...
description: Audits data fetching patterns for performance and correctness — request waterfalls, missing cache revalidation, client-side fetching that should be server-side, and stale-while-revalidate configuration.
---
