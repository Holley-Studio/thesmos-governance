---
name: security-scan
description: Runs a focused security sweep across all changed files using Thesmos's security-related rules — secret detection, direct env access, missing API auth, RLS policy gaps, and admin client boundary violations.
---
...
1. Run `npm run thesmos:review` filtering for security rule categories
