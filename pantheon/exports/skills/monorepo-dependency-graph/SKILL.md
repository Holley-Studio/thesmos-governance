...
description: Maps the dependency graph of a monorepo — which packages depend on which, where circular dependencies exist, and which packages are most critical (highest in-degree) and therefore highest risk to change.
---
