...
description: Audits the project's dependencies for known vulnerabilities, unnecessary or duplicated packages, bundle size impact, and incorrect `devDependencies` vs. `dependencies` classification.
---
