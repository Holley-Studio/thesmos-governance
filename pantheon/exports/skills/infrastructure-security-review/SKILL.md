...
description: Audits Terraform and IaC configuration for security misconfigurations, over-permissive IAM policies, open network access, missing encryption at rest, and secrets embedded in infrastructure code. Maps directly to the Terraform ruleset and AWS Well-Architected Security Pillar.
---
...
1. Run `npm run thesmos:review` on all changed Terraform files
