...
description: Analyses the downstream impact of a refactor before it is merged — identifies all consumers of the changed API, verifies they have all been updated, and estimates the risk of missing call sites.
---
