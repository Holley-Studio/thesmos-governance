...
description: Reviews integration test quality — tests that mock the database (fragile) vs. tests that use a real database (reliable), API integration tests that cover error paths, and test data management correctness.
---
