---
name: state-audit
description: Audits the application's state management — identifies server state duplicated in client stores, context providers causing excessive re-renders, missing memoisation on derived state, and opportunities to move local state to URL params or server state.
---
