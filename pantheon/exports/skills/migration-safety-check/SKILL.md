...
description: Validates database migration files for safe execution in production — checks for locking operations, missing rollbacks, NOT NULL columns without defaults, and sequences that could cause data loss.
---
