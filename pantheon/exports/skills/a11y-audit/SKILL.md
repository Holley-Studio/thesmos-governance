---
name: a11y-audit
description: Audits the application for WCAG 2.1 AA compliance — keyboard navigation, screen reader compatibility, colour contrast, focus management, form label associations, and ARIA attribute correctness.
---
