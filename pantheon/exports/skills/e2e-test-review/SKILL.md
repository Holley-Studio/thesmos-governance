...
description: Reviews end-to-end test quality and coverage — critical user journeys covered, flaky test patterns, test isolation, and CI execution time. Ensures E2E tests provide reliable regression protection.
---
