...
description: Audits the codebase for design token usage — hardcoded colour, spacing, or typography values that should reference the token system, and token definitions that are no longer used by any component.
---
