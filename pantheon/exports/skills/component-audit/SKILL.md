...
description: Audits the component library for duplication, inconsistency, and design system alignment — near-identical components that should be unified, components that bypass the shared UI primitives, and prop API consistency.
---
