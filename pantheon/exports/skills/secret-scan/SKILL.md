---
name: secret-scan
description: Scans diff text and file content for committed secrets — API keys, tokens, connection strings, private keys, and passwords. Operates on both file content and git diff output to catch secrets before they are pushed.
---
...
1. Run `npm run thesmos:review` with diff text — catches `[SEC_001]` patterns
