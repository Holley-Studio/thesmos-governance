...
description: Reviews the complete authentication flow end-to-end — sign-up, sign-in, session management, token refresh, sign-out, and password reset. Verifies each step is correctly secured and handles edge cases.
---
