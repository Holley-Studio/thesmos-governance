...
description: Reviews the application's observability posture — distributed tracing coverage, metrics instrumentation for new features, alert rule coverage for new failure modes, and dashboard completeness for the changed code paths.
---
