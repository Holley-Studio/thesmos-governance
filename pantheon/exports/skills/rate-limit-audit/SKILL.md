...
description: Audits API endpoints and AI-powered routes for rate limiting — missing rate limits on sensitive or expensive endpoints, rate limit configuration correctness, and abuse prevention for AI cost-attack vectors.
---
