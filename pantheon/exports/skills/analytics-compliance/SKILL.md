...
description: Reviews analytics implementation for GDPR and CCPA compliance — consent-gated event firing, PII in event properties, cookie consent configuration, and data retention settings.
---
