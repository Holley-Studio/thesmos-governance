...
description: Incrementally enables TypeScript strict mode by identifying and fixing `any` types, null reference issues, and implicit any return types in a prioritised order that minimises cascading errors.
---
...
1. Run `npm run thesmos:review` to find all `[TS_001]` findings
