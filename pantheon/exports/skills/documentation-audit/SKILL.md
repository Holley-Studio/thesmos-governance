...
description: Audits documentation completeness — exported API surface without JSDoc, changed signatures without updated docs, new environment variables not in `.env.example`, and README sections that reference removed functionality.
---
