...
description: Reviews LLM prompt definitions for safety, quality, and efficiency — injection vulnerabilities, hallucination-prone patterns, unclear output format constraints, and token efficiency.
---
