---
name: csp-audit
description: Audits the Content Security Policy configuration for completeness and correctness — missing directives, overly permissive `unsafe-inline` or `unsafe-eval`, and CSP violations that block legitimate functionality.
---
