...
description: Optimises the project's build configuration and output — identifies tree-shaking opportunities, code splitting candidates, unnecessary re-transpilation, and build cache misses that slow CI.
---
