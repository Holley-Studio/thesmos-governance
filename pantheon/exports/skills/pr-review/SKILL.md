---
name: pr-review
description: Performs a complete Thesmos-governed review of a pull request — scans all changed files, applies all active rules, produces severity-ranked findings, and formats the output for inclusion in a GitHub PR comment.
---
