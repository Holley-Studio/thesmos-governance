...
description: Reviews webhook handler implementations for security — HMAC signature verification, replay attack prevention, idempotency handling, and correct secret management for webhook secrets.
---
...
6. Run `npm run thesmos:review` for `[AUTH_001]` and `[SEC_001]` findings
