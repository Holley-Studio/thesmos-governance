---
name: cors-audit
description: Audits CORS configuration for security — overly permissive wildcard origins, missing `credentials — true` for authenticated cross-origin requests, and CORS headers set on endpoints that should not be cross-origin accessible.
---
