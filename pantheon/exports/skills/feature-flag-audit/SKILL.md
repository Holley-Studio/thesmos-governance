...
description: Audits feature flag usage — data mutations not gated by flags, stale flags from fully-rolled-out features, flag naming convention consistency, and the flag inventory in the codebase vs. the flag management system.
---
