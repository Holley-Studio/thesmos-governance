...
description: Reviews GraphQL schemas and resolvers for depth/complexity limits, auth gaps, N+1 query patterns, type correctness, and production readiness. Covers the full GraphQL security surface — from schema design to resolver implementation to server middleware configuration.
---
